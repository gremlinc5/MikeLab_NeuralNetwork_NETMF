        ...
        : JToken, IEnumerable
    {
        ...
        public void Add(string name, JToken value)
        {
            if (this.IndexOf(name) >= 0)
            {
                ...
                throw new ArgumentException("Duplicate key at: " + index.ToString());
            }
        ...
        /// <summary>
        /// Remove a keyed-value from the object's bag
        /// </summary>
        /// <param name="name"></param>
        /// <param name="value"></param>
        /// <remarks>You cannot use a key that is already existent in the bag</remarks>
        public void Remove(string name)
        {
            ...
            if (this._itemCount >= this._items.Length)
            {
                ...
                Array.Clear(this._items, removeAt, 1);
            }
        }
